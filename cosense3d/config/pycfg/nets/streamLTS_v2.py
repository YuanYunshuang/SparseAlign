...
def get_shared_modules(point_cloud_range, global_ref_time=0, enc_dim=64):
    ...
    return OrderedDict(
        ...
        #     cache_strides=[2],
        #     enc_dim=enc_dim,
        #     floor_height='adaptive',
        # ),

        pts_backbone=dict(
            type='backbone3d.pillar_unet.PillarUnet',
            gather_keys=['points'],
            scatter_keys=['bev_feat'],
            freeze=True,
            data_info=data_info,
        ...
        spatial_alignment=dict(
            ...
            gather_keys=['T_aug2g', 'temp_fusion_feat', 'received_response', 'detection_local'],
            scatter_keys=['T_aug2g_corr'],
            gt_keys=[],
        ),

        spatial_fusion=dict(
            type='fusion.spatial_query_fusion.SpatialAlignment',
            gather_keys=['T_aug2g', 'temp_fusion_feat', 'received_response', 'detection_local', 'global_bboxes_3d'],
